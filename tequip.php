    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class = "text-center">
                        <button onclick="more()" id="myBtn" class = "btn btn-primary" style = "background-color: #f6f5ae;color: #212529;display: inline-block;">Read more</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="card-body">
                    ...
                    <div class = "text-center">
                        <button onclick="more1()" id="myBtn1" class = "btn btn-primary" style = "background-color: #f6f5ae;color: #212529;display: inline-block;">Read more</button>
                    </div> 
                </div>
            </div>
        </div>
