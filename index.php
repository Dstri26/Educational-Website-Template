...
<div style="height: auto">
        <div class="profile-card" style="border-width: 0px;">
            ...
            <p class="profile-bio" style="font-size: 14px;"><br>College of Engineering and Technology has been a pool of meritorious students consistently for many years. And hence it has always tried to facilitate quality engineering education to equip and enrich young men and women to meet global
                ...
                to which this college has been able to become the first and foremost choice of the aspiring engineers of Odisha. Let me also at the same time acknowledge the great alumni power, the present and the past faculty members of the institution
                who have built up this institution to high acclaim.<br>With the guidance of teachers and of the college’s administrative staff, I hope the students will reach their port of dreams, sailing with the wind and sometimes against it; but sail
                they must and not drift or lie at anchor.<br><br></p>
            <ul class="social-list">
                <li> <i class="fa fa-facebook-official" style="background: rgb(188,219,240);"></i></li>
                <li> <i class="fa fa-twitter-square" style="background: rgb(188,219,240);"></i></li>
                <li> <i class="fa fa-linkedin-square" style="background: rgb(188,219,240);"></i></li>
            </ul>
        </div>
    </div>
<?php
